  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-5">
        <p className="opacity-0 animate-fade-up delay-100 text-xs tracking-[0.35em] uppercase text-[#A67C3A] font-[family-name:var(--font-inter)]">
        ...
        <div className="opacity-0 animate-fade-up delay-400 flex items-center gap-5 pt-2">
          <a
            href="#work"
            className="rounded-full border border-[#4E7D53]/40 px-6 py-2.5 text-sm font-medium text-[#a0c8a3] hover:border-[#4E7D53]/80 hover:text-white transition-all duration-200"
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2">
        <div className="h-10 w-px bg-gradient-to-b from-[#2A3A2B]/50 to-transparent" />
      </div>
    </section>
  );
}
